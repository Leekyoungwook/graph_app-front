...
const Sidebar = () => {
  ...
  <div className='sidebar-wrapper dark:bg-gray-950 bg-white py-5 px-4 dark:shadow-[0_0.125rem_0.25rem_rgba(255,255,255,0.3)] shadow-[0_0.125rem_0.25rem_rgba(165,163,174,0.3)] w-[20%] h-full flex flex-col rounded-sm z-[999] fixed left-0'>
    ...
    <div className='sidebar-brand flex items-center ustify-center gap-x [12px]'>
    ...
    <span className='brand-text'>lkw</span>
     </div>
<button className='sidebar-close text-black p-[0.125rem] rounded-sm bg-white cursor-pointer hover:bg-gry-300'>
     <MdOutlineClose />
</button>
     </div>
